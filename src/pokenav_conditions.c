...
static void ConditionGraphDrawMonPic(s16 listId, u8 loadId)
{
    ...
    LoadSpecialPokePic(&gMonFrontPicTable[species], menu->monPicGfx[loadId], species, form, personality, TRUE);
    LZ77UnCompWram(GetMonSpritePalFromSpeciesAndPersonality(species, form, tid, personality), menu->monPal[loadId]);
}
