...
void CB2_StartWallClock(void)
{
    ...
    AddTextPrinterParameterized(WIN_BUTTON_LABEL, FONT_OPTION, gText_Confirm3, 0, 1, 0, NULL);
...
void CB2_ViewWallClock(void)
{
    ...
    AddTextPrinterParameterized(WIN_BUTTON_LABEL, FONT_OPTION, gText_Cancel4, 0, 1, 0, NULL);
    PutWindowTilemap(WIN_BUTTON_LABEL);
    ScheduleBgCopyTilemapToVram(2);
}
...
static void Task_SetClock_AskConfirm(u8 taskId)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, FONT_OPTION, gText_IsThisTheCorrectTime, 0, 1, 0, NULL);
