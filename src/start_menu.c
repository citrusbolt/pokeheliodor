...
static bool8 HandleStartMenuInput(void)
{
	...
	if (JOY_REPEAT(R_BUTTON) && gSaveBlock1Ptr->hueShift < 500)
		gSaveBlock1Ptr->hueShift++;
	if (JOY_REPEAT(L_BUTTON) && gSaveBlock1Ptr->hueShift > -500)
		gSaveBlock1Ptr->hueShift--;
...
{
	ConvertIntToDecimalStringN(gStringVar1, gSaveBlock1Ptr->hueShift + 500, STR_CONV_MODE_RIGHT_ALIGN, 4);
