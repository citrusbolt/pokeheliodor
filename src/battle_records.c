...
static void PrintLinkBattleWinsLossesDraws(struct LinkBattleRecord *records)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, gStringVar4, 0xD0);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar4, x, 0x11, 0, NULL);
}
...
static void PrintLinkBattleRecord(struct LinkBattleRecord *record, u8 y, s32 language)
{
    ...
    {
        // empty slot
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, sText_DashesNoPlayer,   8, (y * 8) + 1, 0, NULL);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, sText_DashesNoScore,  80, (y * 8) + 1, 0, NULL);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, sText_DashesNoScore, 128, (y * 8) + 1, 0, NULL);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, sText_DashesNoScore, 176, (y * 8) + 1, 0, NULL);
    }
    else
    {
        ...
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar1, 8, (y * 8) + 1, 0, NULL);

        ConvertIntToDecimalStringN(gStringVar1, record->wins, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar1,  80, (y * 8) + 1, 0, NULL);

        ConvertIntToDecimalStringN(gStringVar1, record->losses, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar1, 128, (y * 8) + 1, 0, NULL);

        ConvertIntToDecimalStringN(gStringVar1, record->draws, STR_CONV_MODE_RIGHT_ALIGN, 4);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar1, 176, (y * 8) + 1, 0, NULL);
    }
}
...
void ShowLinkBattleRecords(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar4, x, 1, 0, NULL);
    ...
    AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gStringVar4, 0, 41, 0, NULL);
