...
static void FieldUpdateRegionMap(void)
{
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            offset = GetStringCenterAlignXOffset(FONT_OPTION, gText_Hoenn, 0x38);
            AddTextPrinterParameterized(WIN_TITLE, FONT_OPTION, gText_Hoenn, offset, 1, 0, NULL);
...
static void PrintRegionMapSecName(void)
{
    if (sFieldRegionMapHandler->regionMap.mapSecType != MAPSECTYPE_NONE)
    {
        ...
        AddTextPrinterParameterized(WIN_MAPSEC_NAME, FONT_OPTION, sFieldRegionMapHandler->regionMap.mapSecName, 0, 1, 0, NULL);
