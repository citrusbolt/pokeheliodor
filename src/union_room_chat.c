...
static void AddYesNoMenuAt(u8 left, u8 top, u8 initialCursorPos)
{
    ...
    if (sDisplay->yesNoMenuWindowId != WINDOW_NONE)
    {
        ...
        AddTextPrinterParameterized(sDisplay->yesNoMenuWindowId, FONT_OPTION, gText_Yes, 8, 1, TEXT_SKIP_DRAW, NULL);
        AddTextPrinterParameterized(sDisplay->yesNoMenuWindowId, FONT_OPTION, gText_No, 8, 17, TEXT_SKIP_DRAW, NULL);
...
static void DrawTextEntryMessage(u16 x, u8 *str, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized3(WIN_TEXT_ENTRY, FONT_FRLGE, x * 8, 1, color, TEXT_SKIP_DRAW, strBuffer);
}
...
static void ShowKeyboardSwapMenu(void)
{
    ...
    PrintMenuActionTextsAtPos(WIN_SWAP_MENU, FONT_FRLGE, 8, 1, 14, ARRAY_COUNT(sKeyboardPageTitleTexts), sKeyboardPageTitleTexts);
    InitMenuNormal(WIN_SWAP_MENU, FONT_FRLGE, 0, 1, 14, 5, GetCurrentKeyboardPage());
...
static void PrintChatMessage(u16 row, u8 *str, u8 colorIdx)
{
    ...
    AddTextPrinterParameterized3(WIN_CHAT_HISTORY, FONT_FRLGE, 0, row * 15 + 1, color, TEXT_SKIP_DRAW, str);
}
