...
static void MailboxMenu_ItemPrintFunc(u8 windowId, u32 itemId, u8 y)
{
    ...
    AddTextPrinterParameterized4(windowId, FONT_OPTION, 8, y, 0, 0, sPlayerNameTextColors, TEXT_SKIP_DRAW, buffer);
}
...
u8 MailboxMenu_CreateList(struct PlayerPCItemPageStruct *page)
{
    ...
    gMultiuseListMenuTemplate.fontId = FONT_OPTION;
...
static void MoveRelearnerLoadBattleMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, str, 128);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, x, 1, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPP;
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, 4, 41, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPower;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 106);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, x, 25, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAccuracy;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 106);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, x, 41, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, 4, 25, TEXT_SKIP_DRAW, NULL);

    x = 4 + GetStringWidth(FONT_OPTION, gText_MoveRelearnerPP, 0);
    ConvertIntToDecimalStringN(buffer, move->pp, STR_CONV_MODE_LEFT_ALIGN, 2);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, buffer, x, 41, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, 106, 25, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, FONT_OPTION, str, 106, 41, TEXT_SKIP_DRAW, NULL);
...
static void MoveRelearnerMenuLoadContestMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, str, 128);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, FONT_OPTION, str, x, 1, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAppeal;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 92);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, FONT_OPTION, str, x, 25, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerJam;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 92);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, FONT_OPTION, str, x, 41, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, FONT_OPTION, str, 4, 25, TEXT_SKIP_DRAW, NULL);
...
void MoveRelearnerPrintMessage(u8 *str)
{
    ...
    AddTextPrinterParameterized2(RELEARNERWIN_MSG, FONT_OPTION, str, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, 3);
}
...
void GetConditionMenuMonGfx(void *tilesDst, void *palDst, u16 boxId, u16 monId, u16 partyId, u16 numMons, bool8 excludesCancel)
{
    ...
    if (partyId != numMons)
    {
        ...
        LoadSpecialPokePic(&gMonFrontPicTable[species], tilesDst, species, form, personality, TRUE);
        LZ77UnCompWram(GetMonSpritePalFromSpeciesAndPersonality(species, form, trainerId, personality), palDst);
    }
}
