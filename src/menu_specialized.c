...
static void MoveRelearnerLoadBattleMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, str, 0x80);
    AddTextPrinterParameterized(0, FONT_OPTION, str, x, 1, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPP;
    AddTextPrinterParameterized(0, FONT_OPTION, str, 4, 0x29, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPower;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 0x6A);
    AddTextPrinterParameterized(0, FONT_OPTION, str, x, 0x19, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAccuracy;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 0x6A);
    AddTextPrinterParameterized(0, FONT_OPTION, str, x, 0x29, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(0, FONT_OPTION, str, 4, 0x19, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(0, FONT_OPTION, buffer, x, 0x29, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(0, FONT_OPTION, str, 0x6A, 0x19, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(0, FONT_OPTION, str, 0x6A, 0x29, TEXT_SKIP_DRAW, NULL);
...
static void MoveRelearnerMenuLoadContestMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, str, 0x80);
    AddTextPrinterParameterized(1, FONT_OPTION, str, x, 1, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAppeal;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 0x5C);
    AddTextPrinterParameterized(1, FONT_OPTION, str, x, 0x19, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerJam;
    x = GetStringRightAlignXOffset(FONT_OPTION, str, 0x5C);
    AddTextPrinterParameterized(1, FONT_OPTION, str, x, 0x29, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(1, FONT_OPTION, str, 4, 0x19, TEXT_SKIP_DRAW, NULL);
...
void MoveRelearnerPrintText(u8 *str)
{
    ...
    AddTextPrinterParameterized2(3, FONT_OPTION, str, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, 3);
}
