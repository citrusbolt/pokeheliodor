...
static const struct GFRomHeader sGFRomHeader = {
    ...
    .moveNames = gGameCubeMoveNames,
    .decorations = gDecorations,
    .flagsOffset = offsetof(struct SaveBlock1, flags),
    .varsOffset = offsetof(struct SaveBlock1, vars),
    .pokedexOffset = offsetof(struct SaveBlock2, pokedex),
    .seen1Offset = offsetof(struct SaveBlock2, pokedex) + offsetof(struct Pokedex, seen),
    .seen2Offset = offsetof(struct SaveBlock2, pokedex) + offsetof(struct Pokedex, seen),
