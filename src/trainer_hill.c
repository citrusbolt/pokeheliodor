...
void PrintOnTrainerHillRecordsWindow(void)
{
    ...
    x = GetStringCenterAlignXOffset(FONT_OPTION, gText_TimeBoard, 0xD0);
    AddTextPrinterParameterized3(0, FONT_OPTION, x, 2, sRecordWinColors, TEXT_SKIP_DRAW, gText_TimeBoard);

    y = 18;
    for (i = 0; i < NUM_TRAINER_HILL_MODES; i++)
    {
        AddTextPrinterParameterized3(0, FONT_OPTION, 0, y, sRecordWinColors, TEXT_SKIP_DRAW, sModeStrings[i]);
        y += 15;
        ...
        x = GetStringRightAlignXOffset(FONT_OPTION, gStringVar4, 0xD0);
        AddTextPrinterParameterized3(0, FONT_OPTION, x, y, sRecordWinColors, TEXT_SKIP_DRAW, gStringVar4);
        y += 17;
    }
