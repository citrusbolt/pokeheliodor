const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_LONELY_MINT] = {gItemIcon_MintAttack, gItemIconPalette_MintAttack},
    [ITEM_ADAMANT_MINT] = {gItemIcon_MintAttack, gItemIconPalette_MintAttack},
    [ITEM_NAUGHTY_MINT] = {gItemIcon_MintAttack, gItemIconPalette_MintAttack},
    [ITEM_BRAVE_MINT] = {gItemIcon_MintAttack, gItemIconPalette_MintAttack},
    [ITEM_BOLD_MINT] = {gItemIcon_MintDefense, gItemIconPalette_MintDefense},
    [ITEM_IMPISH_MINT] = {gItemIcon_MintDefense, gItemIconPalette_MintDefense},
    [ITEM_LAX_MINT] = {gItemIcon_MintDefense, gItemIconPalette_MintDefense},
    [ITEM_RELAXED_MINT] = {gItemIcon_MintDefense, gItemIconPalette_MintDefense},
    [ITEM_MODEST_MINT] = {gItemIcon_MintSpAtk, gItemIconPalette_MintSpAtk},
    [ITEM_MILD_MINT] = {gItemIcon_MintSpAtk, gItemIconPalette_MintSpAtk},
    [ITEM_RASH_MINT] = {gItemIcon_MintSpAtk, gItemIconPalette_MintSpAtk},
    [ITEM_QUIET_MINT] = {gItemIcon_MintSpAtk, gItemIconPalette_MintSpAtk},
    [ITEM_CALM_MINT] = {gItemIcon_MintSpDef, gItemIconPalette_MintSpDef},
    [ITEM_GENTLE_MINT] = {gItemIcon_MintSpDef, gItemIconPalette_MintSpDef},
    [ITEM_CAREFUL_MINT] = {gItemIcon_MintSpDef, gItemIconPalette_MintSpDef},
    [ITEM_SASSY_MINT] = {gItemIcon_MintSpDef, gItemIconPalette_MintSpDef},
    [ITEM_TIMID_MINT] = {gItemIcon_MintSpeed, gItemIconPalette_MintSpeed},
    [ITEM_HASTY_MINT] = {gItemIcon_MintSpeed, gItemIconPalette_MintSpeed},
    [ITEM_JOLLY_MINT] = {gItemIcon_MintSpeed, gItemIconPalette_MintSpeed},
    [ITEM_NAIVE_MINT] = {gItemIcon_MintSpeed, gItemIconPalette_MintSpeed},
    [ITEM_SERIOUS_MINT] = {gItemIcon_MintNeutral, gItemIconPalette_MintNeutral},
