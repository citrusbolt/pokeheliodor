const u16 gTutorMoves[TUTOR_MOVE_COUNT] =
{
    ...
    [TUTOR_MOVE_FAINT_ATTACK] = MOVE_FAINT_ATTACK,
    [TUTOR_MOVE_FAKE_OUT] = MOVE_FAKE_OUT,
    [TUTOR_MOVE_HYPNOSIS] = MOVE_HYPNOSIS,
    [TUTOR_MOVE_NIGHT_SHADE] = MOVE_NIGHT_SHADE,
    [TUTOR_MOVE_ROLE_PLAY] = MOVE_ROLE_PLAY,
    [TUTOR_MOVE_ZAP_CANNON] = MOVE_ZAP_CANNON,
};

#define TUTOR(move) ((u64)1u << (TUTOR_##move))
...
static const u64 sTutorLearnsets[] =
{
    ...
    [SPECIES_MEW]              = (TUTOR(MOVE_MEGA_PUNCH)
                                ...
                                | TUTOR(MOVE_SELF_DESTRUCT)
                                | TUTOR(MOVE_SKY_ATTACK)
                                | TUTOR(MOVE_FAINT_ATTACK)
                                | TUTOR(MOVE_FAKE_OUT)
                                | TUTOR(MOVE_HYPNOSIS)
                                | TUTOR(MOVE_NIGHT_SHADE)
                                | TUTOR(MOVE_ROLE_PLAY)
                                | TUTOR(MOVE_ZAP_CANNON)),
