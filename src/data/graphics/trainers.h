...
const u32 gTrainerPalette_EmeraldBrendan[] = INCBIN_U32("graphics/trainers/palettes/brendan_e.gbapal.lz");
const u32 gTrainerPalette_EmeraldMay[] = INCBIN_U32("graphics/trainers/palettes/may_e.gbapal.lz");
