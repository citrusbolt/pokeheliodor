...
static const u8 sMapName_MtBtlColosseum[] = _("Mt. Battle Colosseum");
static const u8 sMapName_RealgamTower[] = _("Realgam Tower");
static const u8 sMapName_RealgamTwrDome[] = _("Realgam Tower Dome");
static const u8 sMapName_RealgamTwrLobby[] = _("Realgam Tower Lobby");
...
//Johto met locations using CrystalDust as the standard	
	[MAPSEC_NEW_BARK_TOWN_CD]              = { 0, 0, 0, 0, sMapName_NewBarkTown},
	[MAPSEC_CHERRYGROVE_CITY_CD]           = { 0, 0, 0, 0, sMapName_CherrygroveCity},
	[MAPSEC_AZALEA_TOWN_CD]                = { 0, 0, 0, 0, sMapName_AzaleaTown},
	[MAPSEC_CIANWOOD_CITY_CD]              = { 0, 0, 0, 0, sMapName_CianwoodCity},
	[MAPSEC_MAHOGANY_TOWN_CD]              = { 0, 0, 0, 0, sMapName_MahoganyTown},
	[MAPSEC_VIOLET_CITY_CD]                = { 0, 0, 0, 0, sMapName_VioletCity},
	[MAPSEC_ECRUTEAK_CITY_CD]              = { 0, 0, 0, 0, sMapName_EcruteakCity},
	[MAPSEC_OLIVINE_CITY_CD]               = { 0, 0, 0, 0, sMapName_OlivineCity},
	[MAPSEC_GOLDENROD_CITY_CD]             = { 0, 0, 0, 0, sMapName_GoldenrodCity},
	[MAPSEC_BLACKTHORN_CITY_CD]            = { 0, 0, 0, 0, sMapName_BlackthornCity},
	[MAPSEC_ROUTE_29_CD]                   = { 0, 0, 0, 0, sMapName_Route29},
	[MAPSEC_ROUTE_30_CD]                   = { 0, 0, 0, 0, sMapName_Route30},
	[MAPSEC_ROUTE_31_CD]                   = { 0, 0, 0, 0, sMapName_Route31},
	[MAPSEC_ROUTE_32_CD]                   = { 0, 0, 0, 0, sMapName_Route32},
	[MAPSEC_ROUTE_33_CD]                   = { 0, 0, 0, 0, sMapName_Route33},
	[MAPSEC_ROUTE_34_CD]                   = { 0, 0, 0, 0, sMapName_Route34},
	[MAPSEC_ROUTE_35_CD]                   = { 0, 0, 0, 0, sMapName_Route35},
	[MAPSEC_ROUTE_36_CD]                   = { 0, 0, 0, 0, sMapName_Route36},
	[MAPSEC_ROUTE_37_CD]                   = { 0, 0, 0, 0, sMapName_Route37},
	[MAPSEC_ROUTE_38_CD]                   = { 0, 0, 0, 0, sMapName_Route38},
	[MAPSEC_ROUTE_39_CD]                   = { 0, 0, 0, 0, sMapName_Route39},
	[MAPSEC_ROUTE_40_CD]                   = { 0, 0, 0, 0, sMapName_Route40},
	[MAPSEC_ROUTE_41_CD]                   = { 0, 0, 0, 0, sMapName_Route41},
	[MAPSEC_ROUTE_42_CD]                   = { 0, 0, 0, 0, sMapName_Route42},
	[MAPSEC_ROUTE_43_CD]                   = { 0, 0, 0, 0, sMapName_Route43},
	[MAPSEC_ROUTE_44_CD]                   = { 0, 0, 0, 0, sMapName_Route44},
	[MAPSEC_ROUTE_45_CD]                   = { 0, 0, 0, 0, sMapName_Route45},
	[MAPSEC_ROUTE_46_CD]                   = { 0, 0, 0, 0, sMapName_Route46},
	[MAPSEC_ROUTE_26_CD]                   = { 0, 0, 0, 0, sMapName_Route26},
	[MAPSEC_ROUTE_27_CD]                   = { 0, 0, 0, 0, sMapName_Route27},
	[MAPSEC_ROUTE_28_CD]                   = { 0, 0, 0, 0, sMapName_Route28},
	[MAPSEC_ROUTE_32_FLYDUP_CD]            = { 0, 0, 0, 0, sMapName_Route32},
	[MAPSEC_DARK_CAVE_CD]                  = { 0, 0, 0, 0, sMapName_DarkCave},
	[MAPSEC_SLOWPOKE_WELL_CD]              = { 0, 0, 0, 0, sMapName_SlowpokeWell_B1F},
	[MAPSEC_BATTLE_FRONTIER_CD]            = { 0, 0, 0, 0, sMapName_BattleFrontier},
	[MAPSEC_ILEX_FOREST_CD]                = { 0, 0, 0, 0, sMapName_IlexForest},
	[MAPSEC_UNION_CAVE_CD]                 = { 0, 0, 0, 0, sMapName_UnionCave},
	[MAPSEC_SPROUT_TOWER_CD]               = { 0, 0, 0, 0, sMapName_SproutTower},
	[MAPSEC_RUINS_OF_ALPH_CD]              = { 0, 0, 0, 0, sMapName_RuinsOfAlph},
	[MAPSEC_ALPH_CHAMBERS_CD]              = { 0, 0, 0, 0, sMapName_AlphChambers},
	[MAPSEC_RADIO_TOWER_CD]                = { 0, 0, 0, 0, sMapName_RadioTower},
	[MAPSEC_MT_MORTAR_CD]                  = { 0, 0, 0, 0, sMapName_MtMortar},
	[MAPSEC_LIGHTHOUSE_CD]                 = { 0, 0, 0, 0, sMapName_Lighthouse},
	[MAPSEC_DRAGONS_DEN_CD]                = { 0, 0, 0, 0, sMapName_DragonsDen},
	[MAPSEC_LAKE_OF_RAGE_CD]               = { 0, 0, 0, 0, sMapName_LakeOfRage},
	[MAPSEC_NATIONAL_PARK_CD]              = { 0, 0, 0, 0, sMapName_NationalPark},
	[MAPSEC_ICE_PATH_CD]                   = { 0, 0, 0, 0, sMapName_IcePath},
	[MAPSEC_SILVER_CAVE_CD]                = { 0, 0, 0, 0, sMapName_SilverCave},
	[MAPSEC_WHIRL_ISLANDS_CD]              = { 0, 0, 0, 0, sMapName_WhirlIslands},
	[MAPSEC_TIN_TOWER_CD]                  = { 0, 0, 0, 0, sMapName_TinTower},

//Orre met locations
	[MAPSEC_DISTANT_LAND]               = { 0, 0, 0, 0, sMapName_DistantLand},
	[MAPSEC_OUTSKIRT_STAND]             = { 0, 0, 0, 0, sMapName_OutskirtStand},
	[MAPSEC_PHENAC_CITY]                = { 0, 0, 0, 0, sMapName_PhenacCity},
	[MAPSEC_MAYORS_HOUSE]               = { 0, 0, 0, 0, sMapName_MayorsHouse},
	[MAPSEC_PRE_GYM]                    = { 0, 0, 0, 0, sMapName_PreGym},
	[MAPSEC_PHENAC_STADIUM]             = { 0, 0, 0, 0, sMapName_PhenacStadium},
	[MAPSEC_PYRITE_TOWN]                = { 0, 0, 0, 0, sMapName_PyriteTown},
	[MAPSEC_PYRITE_BLDG]                = { 0, 0, 0, 0, sMapName_PyriteBldg},
	[MAPSEC_PYRITE_CAVE]                = { 0, 0, 0, 0, sMapName_PyriteCave},
	[MAPSEC_MIRORS_HIDEOUT]             = { 0, 0, 0, 0, sMapName_MirorsHideout},
	[MAPSEC_PYRITE_COLOSSEUM]           = { 0, 0, 0, 0, sMapName_PyriteColosseum},
	[MAPSEC_AGATE_VILLAGE]              = { 0, 0, 0, 0, sMapName_AgateVillage},
	[MAPSEC_RELIC_CAVE]                 = { 0, 0, 0, 0, sMapName_RelicCave},
	[MAPSEC_THE_UNDER]                  = { 0, 0, 0, 0, sMapName_TheUnder},
	[MAPSEC_THE_UNDER_SUBWAY]           = { 0, 0, 0, 0, sMapName_TheUnderSubway},
	[MAPSEC_UNDER_COLOSSEUM]            = { 0, 0, 0, 0, sMapName_UnderColosseum},
	[MAPSEC_DEEP_COLOSSEUM]             = { 0, 0, 0, 0, sMapName_DeepColosseum},
	[MAPSEC_FRONT_OF_LAB]               = { 0, 0, 0, 0, sMapName_FrontOfLab},
	[MAPSEC_LABORATORY]                 = { 0, 0, 0, 0, sMapName_Laboratory},
	[MAPSEC_MT_BATTLE]                  = { 0, 0, 0, 0, sMapName_MtBattle},
	[MAPSEC_MTBTL_COLOSSEUM]            = { 0, 0, 0, 0, sMapName_MtBtlColosseum},
	[MAPSEC_REALGAM_TOWER]              = { 0, 0, 0, 0, sMapName_RealgamTower},
	[MAPSEC_REALGAMTWR_DOME]            = { 0, 0, 0, 0, sMapName_RealgamTwrDome},
	[MAPSEC_REALGAMTWR_LOBBY]           = { 0, 0, 0, 0, sMapName_RealgamTwrLobby},
	[MAPSEC_TOWER_COLOSSEUM]            = { 0, 0, 0, 0, sMapName_TowerColosseum},
	[MAPSEC_ORRE_COLOSSEUM]             = { 0, 0, 0, 0, sMapName_OrreColosseum},
	[MAPSEC_SNAGEM_HIDEOUT]             = { 0, 0, 0, 0, sMapName_SnagemHideout},
	[MAPSEC_REALGAM_TOWER_2F]           = { 0, 0, 0, 0, sMapName_RealgamTower2F},
	[MAPSEC_CIPHER_LAB]                 = { 0, 0, 0, 0, sMapName_CipherLab},
	[MAPSEC_S_S_LIBRA]                  = { 0, 0, 0, 0, sMapName_SSLibra},
	[MAPSEC_CIPHER_KEY_LAIR]            = { 0, 0, 0, 0, sMapName_CipherKeyLair},
	[MAPSEC_CITADARK_ISLE]              = { 0, 0, 0, 0, sMapName_CitadarkIsle},
	[MAPSEC_ROCK]                       = { 0, 0, 0, 0, sMapName_Rock},
	[MAPSEC_OASIS]                      = { 0, 0, 0, 0, sMapName_Oasis},
