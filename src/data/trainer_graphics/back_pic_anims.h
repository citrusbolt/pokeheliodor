...
const union AnimCmd *const *const gTrainerBackAnimsPtrTable[] =
{
    ...
    [TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN] = sBackAnims_FourFrame,
    [TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY] = sBackAnims_FourFrame,
    [TRAINER_BACK_PIC_WALLY] = sBackAnims_FourFrame,
    [TRAINER_BACK_PIC_STEVEN] = sBackAnims_FourFrame,
    [TRAINER_BACK_PIC_EMERALD_BRENDAN] = sBackAnims_FiveFrame,
    [TRAINER_BACK_PIC_EMERALD_MAY] = sBackAnims_FiveFrame,
