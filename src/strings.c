...
const u8 gText_PowerPurchaseLucky1[] = _("H-LUCKY {LV}1{CLEAR_TO 0x63}1pt");
const u8 gText_PowerPurchaseLucky2[] = _("H-LUCKY {LV}2{CLEAR_TO 0x63}2pt");
const u8 gText_PowerPurchaseLucky3[] = _("H-LUCKY {LV}3{CLEAR_TO 0x63}3pt");
