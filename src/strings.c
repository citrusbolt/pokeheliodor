...
const u8 gText_SaveFileConvertRS[] = _("Your Pokémon Ruby or Pokémon Sapphire\nsave file will be converted\lfor use with Pokémon Heliodor.");
const u8 gText_SaveFileConvertNo[] = _("A suitable save file was not located.\nSave data will now be initialized.");
const u8 gText_SaveFileConvertE[] = _("Your Pokémon Emerald save file\nwill be converted for use\lwith Pokémon Heliodor.");
...
const u8 gText_CoinCase[] = _("Coin Quantity: {STR_VAR_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnElevatedToLvVar2[] = _("{STR_VAR_1} grew to Lv. {STR_VAR_2}!");
...
const u8 gText_CoolnessContestMenu[] = _("COOLNESS CONTEST");
const u8 gText_BeautyContestMenu[] = _("BEAUTY CONTEST");
const u8 gText_CutenessContestMenu[] = _("CUTENESS CONTEST");
const u8 gText_SmartnessContestMenu[] = _("SMARTNESS CONTEST");
const u8 gText_ToughnessContestMenu[] = _("TOUGHNESS CONTEST");
...
const u8 gText_MenuOptionSave[] = _("SAVE {R_BUTTON}");
...
const u8 gText_UpGrade3BP[] = _("Upgrade{CLEAR_TO 0x64}3BP");
const u8 gText_DeepSeaScale3BP[] = _("Deep Sea Scale{CLEAR_TO 0x64}3BP");
const u8 gText_DeepSeaTooth3BP[] = _("Deep Sea Tooth{CLEAR_TO 0x64}3BP");
...
const u8 gText_Stick48BP[] = _("Leek{CLEAR_TO 0x5E}48BP");
...
const u8 gText_MenuSave[] = _("SAVE {R_BUTTON}");
...
ALIGNED(4) const u8 gText_CantSendGiftToTrainer[] = _("You can't send this Mystery Gift to\nthis Trainer.");
...
const u8 gText_AshQty[] = _("Ash Quantity: {STR_VAR_1}{PAUSE_UNTIL_PRESS}");
...
const u8 gText_HCardShinyCount[] = _("SHINY POKéMON FOUND");
...
const u8 gText_HCardPokeCoupons[] = _("POKé COUPONS EARNED");
const u8 gText_HCardNumPokeCoupons[] = _("{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}pt");
const u8 gText_HCardWinsLosses[] = _("W:{CLEAR_TO 0x30}L:");
const u8 gText_HCardTrainerName[] = _("TRAINER:{CLEAR_TO 3}{STR_VAR_1}");
const u8 gText_HCardLinkTrades[] = _("LINK TRADES");
const u8 gText_HCardFrontBattlePoints[] = _("BATTLE POINTS");
const u8 gText_HCardFrontPokeCoupons[] = _("POKé COUPONS");
const u8 gText_HCardFrontBattlePointsQuantity[] = _("{STR_VAR_1}BP");
const u8 gText_HCardFrontPokeCouponsQuantity[] = _("{STR_VAR_1}pt");
...
const u8 gText_CardTerminal_StickerShiny[] = _("SHINY {PKMN} FOUND");
...
const u8 gText_CardTerminal_StatTrade[] = _("LINK TRADES");
...
const u8 gText_CardTerminal_StatShiny[] = _("SHINY POKéMON FOUND");
const u8 gText_CardTerminal_StatPowerPoints[] = _("POWER POINTS EARNED");
const u8 gText_CardTerminal_StatPokeCoupons[] = _("POKé COUPONS EARNED");
...
const u8 gText_CardTerminal_StickerShinyName[] = _("SHINY");
...
const u8 gText_WhatToDoWithTicket[] = _("What would you like to do\nwith the Event Ticket?");
const u8 gText_SendingEventTicket[] = _("Sending the Event Ticket…");
const u8 gText_EventTicketSentTo[] = _("The Event Ticket has been sent\nto {STR_VAR_1}.");
