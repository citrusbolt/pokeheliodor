...
const u8 gText_HCardTowerStats[] = _("{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}W:  {COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}   {COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}S:  {COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}");
