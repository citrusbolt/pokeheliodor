...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.\n{DYNAMIC 5}: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}\n{DYNAMIC 6}\n{DYNAMIC 7}");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, hatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.\n{DYNAMIC 5}: {DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}\n{DYNAMIC 6}\n{DYNAMIC 7}");
