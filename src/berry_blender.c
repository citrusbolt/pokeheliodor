...
static void PrintPlayerNames(void)
{
    ...
    for (i = 0; i < BLENDER_MAX_PLAYERS; i++)
    {
        if (sBerryBlender->arrowIdToPlayerId[i] != NO_PLAYER)
        {
            ...
            xPos = GetStringCenterAlignXOffset(FONT_OPTION, text, 0x38);
    ...
    case 3:
        {
            ...
            xPos = GetStringCenterAlignXOffset(FONT_OPTION, sText_BlendingResults, 0xA8);
            ...
            xPos = GetStringRightAlignXOffset(FONT_OPTION, sBerryBlender->stringVar, 0xA8);
...
static bool8 PrintBlendingRanking(void)
{
    ...
    case 3:
        ...
        xPos = GetStringCenterAlignXOffset(FONT_OPTION, sText_Ranking, 168);
...
void ShowBerryBlenderRecordWindow(void)
{
    ...
    xPos = GetStringCenterAlignXOffset(FONT_OPTION, gText_BlenderMaxSpeedRecord, 144);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gText_BlenderMaxSpeedRecord, xPos, 1, 0, NULL);
    AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, gText_234Players, 4, 41, 0, NULL);
    ...
    for (i = 0, yPos = 41; i < NUM_SCORE_TYPES; i++)
    {
        ...
        xPos = GetStringRightAlignXOffset(FONT_OPTION, text, 140);
        AddTextPrinterParameterized(gRecordsWindowId, FONT_OPTION, text, xPos, yPos + (i * 16), 0, NULL);
    }
...
static void Blender_AddTextPrinter(u8 windowId, const u8 *string, u8 x, u8 y, s32 speed, s32 caseId)
{
    ...
    AddTextPrinterParameterized4(windowId, FONT_OPTION, x, y, letterSpacing, 1, txtColor, speed, string);
}
