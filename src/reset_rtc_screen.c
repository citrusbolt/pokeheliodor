...
static void PrintTime(u8 windowId, u8 x, u8 y, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_OPTION, gStringVar4, x, y, TEXT_SKIP_DRAW, NULL);
}
...
static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_OPTION, gText_Confirm2, 126, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, FONT_OPTION, str, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(WIN_TIME, FONT_OPTION, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0);
        PrintTime(
            WIN_TIME,
            0,
            17,
        ...
        AddTextPrinterParameterized(WIN_TIME, FONT_OPTION, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0);
        PrintTime(
            WIN_TIME,
            0,
            49,
