...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterized(1, FONT_OPTION, str, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, FONT_OPTION, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            17,
        ...
        AddTextPrinterParameterized(0, FONT_OPTION, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            49,
