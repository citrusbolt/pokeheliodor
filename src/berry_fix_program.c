...
static void BerryFix_GpuSet(void)
{
    ...
    width = GetStringWidth(FONT_OPTION, sText_BerryProgramUpdate, 0);
    left = (208 - width) / 2;
    AddTextPrinterParameterized3(WIN_TITLE, FONT_OPTION, left, 2, sBerryProgramTextColors, TEXT_SKIP_DRAW, sText_BerryProgramUpdate);
...
static void BerryFix_SetScene(int scene)
{
    ...
    AddTextPrinterParameterized3(WIN_MSG_BODY, FONT_OPTION, 0, 0, sBerryProgramTextColors, TEXT_SKIP_DRAW, sBerryProgramTexts[scene]);
