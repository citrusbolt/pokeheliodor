...
static bool32 UpdateConditionGraphMenuWindows(u8 mode, u16 bufferIndex, bool8 winMode)
{
    ...
    case 1:
        if (GetConditionGraphCurrentListIndex() != GetMonListCount() - 1 || IsConditionMenuSearchMode() == TRUE)
        {
            ...
            AddTextPrinterParameterized(menu->nameGenderWindowId, FONT_OPTION, str, 0, 1, 0, NULL);
        }
        break;
    case 2:
        if (IsConditionMenuSearchMode() == TRUE)
        {
            ...
            AddTextPrinterParameterized(menu->nameGenderWindowId, FONT_OPTION, str, 0, 17, 0, NULL);
            ...
            AddTextPrinterParameterized(menu->listIndexWindowId, FONT_OPTION, text, 4, 1, 0, NULL);
            ConvertIntToDecimalStringN(&text[5], GetConditionMonDataBuffer(), STR_CONV_MODE_RIGHT_ALIGN, 4);
            AddTextPrinterParameterized(menu->listIndexWindowId, FONT_OPTION, text, 28, 1, 0, NULL);
        }
        break;
    case 3:
