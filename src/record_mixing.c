...
struct PlayerRecordRS
{
    ...
    struct SecretBase secretBasesBlank[20 - SECRET_BASES_COUNT];
...
static void ReceiveEnigmaBerry(struct EnigmaBerry *, u8);
static void ReceiveEnigmaBerryDesc(struct EnigmaBerryDesc *, u8);
...
static void PrintTextOnRecordMixing(const u8 *src)
{
    ...
    AddTextPrinterParameterized(0, FONT_OPTION, src, 0, 1, 0, NULL);
...
static void ReceiveEnigmaBerry(struct EnigmaBerry *enigmaBerry, u8 multiplayerId)
{
    // TODO
}

static void ReceiveEnigmaBerryDesc(struct EnigmaBerryDesc *enigmaBerryDesc, u8 multiplayerId)
{
    // TODO
}
