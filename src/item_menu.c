...
const struct MenuAction sItemMenuActions[] = {
    ...
    [ITEM_MENU_ACTION_CONFIRM] = {gMenuText_Confirm, Task_FadeAndCloseBagMenu},
...
const u8 gUnknown_0861402C[] = {ITEM_MENU_ACTION_USE, ITEM_MENU_ACTION_GIVE, ITEM_MENU_ACTION_TOSS, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614030[] = {ITEM_MENU_ACTION_USE, ITEM_MENU_ACTION_REGISTER, ITEM_MENU_ACTION_COUNT, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614034[] = {ITEM_MENU_ACTION_GIVE, ITEM_MENU_ACTION_COUNT, ITEM_MENU_ACTION_TOSS, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614038[] = {ITEM_MENU_ACTION_USE, ITEM_MENU_ACTION_GIVE, ITEM_MENU_ACTION_COUNT, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_0861403C[] = {ITEM_MENU_ACTION_CHECK_TAG, ITEM_MENU_ACTION_COUNT, ITEM_MENU_ACTION_USE, ITEM_MENU_ACTION_GIVE, ITEM_MENU_ACTION_TOSS, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614042[] = {ITEM_MENU_ACTION_USE_IN_BATTLE, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614044[] = {ITEM_MENU_ACTION_GIVE, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_08614046 = ITEM_MENU_ACTION_CANCEL;
const u8 gUnknown_08614047[] = {ITEM_MENU_ACTION_CONFIRM, ITEM_MENU_ACTION_CHECK_TAG, ITEM_MENU_ACTION_COUNT, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_0861404B[] = {ITEM_MENU_ACTION_SHOW, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_0861404D[] = {ITEM_MENU_ACTION_GIVE_2, ITEM_MENU_ACTION_CANCEL};
const u8 gUnknown_0861404F[] = {ITEM_MENU_ACTION_CONFIRM_2, ITEM_MENU_ACTION_CANCEL};
