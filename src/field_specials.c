        ...
        graphicsId == OBJ_EVENT_GFX_STEVEN)
    {
        ...
        if (obj != OBJECT_EVENTS_COUNT)
        {
            ...
            case OBJ_EVENT_GFX_LINK_RS_MAY:
                LoadPalette(gObjectEventPal_RubySapphireHero, 0x100 + (adjustedPaletteNum << 4), 0x20);
                break;
            ...
            case OBJ_EVENT_GFX_WALLY:
                LoadPalette(gObjectEventPal_RubySapphireHero, 0x100 + (adjustedPaletteNum << 4), 0x20);	//Not correct, but will work for testing
                break;
    ...
    if ((menu >= SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_1 && menu <= SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR) || menu >= SCROLL_MULTI_COUPON_EXCHANGE)
    {
        ...
        switch (menu)
        {
            ...
            case SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2:
                ...
                break;
            case SCROLL_MULTI_BF_EXCHANGE_CORNER_STONE_VENDOR:
                AddTextPrinterParameterized2(0, 1, sFrontierExchangeCorner_StonesDescriptions[selection], 0, NULL, 2, 1, 3);
