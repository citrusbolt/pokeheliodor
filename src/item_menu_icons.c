...
static const union AnimCmd *const sBagSpriteAnimTable[] =
{
    ...
    [POCKET_MEDICINE]     = sSpriteAnim_Bag_TMsHMs,
    [POCKET_POKE_BALLS]   = sSpriteAnim_Bag_Pokeballs,
    [POCKET_BATTLE_ITEMS] = sSpriteAnim_Bag_TMsHMs,
    [POCKET_TREASURES]    = sSpriteAnim_Bag_Berries,
    [POCKET_KEY_ITEMS]    = sSpriteAnim_Bag_KeyItems,
    [POCKET_FREE_SPACE]   = sSpriteAnim_Bag_KeyItems,
    [POCKET_TM_HM]        = sSpriteAnim_Bag_Closed,
    [POCKET_BERRIES]      = sSpriteAnim_Bag_Closed,
    [POCKET_MAIL]         = sSpriteAnim_Bag_Closed,
};
    ...
    if (*spriteId == SPRITE_NONE)
    {
        ...
        if (iconSpriteId != MAX_SPRITES)
        {
            *spriteId = iconSpriteId;
            gSprites[iconSpriteId].x2 = 21;
            gSprites[iconSpriteId].y2 = 87;
        }
    }
}
