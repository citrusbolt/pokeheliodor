    ...
    if (!gPaletteFade.active)
    {
        ...
        switch (gTasks[taskId].tMenuType)
        {
            ...
            case HAS_SAVED_GAME:
                ...
                AddTextPrinterParameterized3(4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuGameCube);
            ...
            case HAS_MYSTERY_GIFT:
                ...
                AddTextPrinterParameterized3(3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuGameCube);
                AddTextPrinterParameterized3(5, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryGift);
            ...
            case HAS_MYSTERY_EVENTS:
                ...
                AddTextPrinterParameterized3(2, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuContinue);
                AddTextPrinterParameterized3(3, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuNewGame);
                AddTextPrinterParameterized3(4, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryEvents);
                AddTextPrinterParameterized3(5, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuGameCube);
                AddTextPrinterParameterized3(6, 1, 0, 1, sTextColor_Headers, -1, gText_MainMenuMysteryGift);
                ...
                if (sCurrItemAndOptionMenuCheck == 4)
                {
                    ...
                    tIsScrolled = 1;
                    gTasks[tScrollArrowTaskId].tArrowTaskIsScrolled = 1;
                }
...
static bool8 HandleMainMenuInput(u8 taskId)
{
    ...
    {
        if (tIsScrolled == 0 && tCurrItem == 3)
        {
            ChangeBgY(0, 0x2000, 1);
            ChangeBgY(1, 0x2000, 1);
            gTasks[tScrollArrowTaskId].tArrowTaskIsScrolled = tIsScrolled = 1;
        }
        else if (tIsScrolled == 1 && tCurrItem == 4)
        {
            ChangeBgY(0, 0x2000, 1);
            ChangeBgY(1, 0x2000, 1);
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
	...
	if (cheer)
		CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_PLUSLE);
	else
		CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, 0x0000FFFF, SPECIES_MINUN);
...
{
	if (cheer)
		return CreatePicSprite2(SPECIES_PLUSLE, SHINY_ODDS, 0, 1, a, b, 14, -1);
	else
		return CreatePicSprite2(SPECIES_MINUN, SHINY_ODDS, 0, 1, a, b, 14, -1);
}
...
static void CreateMainMenuErrorWindow(const u8* str)
{
    ...
    AddTextPrinterParameterized(8, 1, str, 0, 1, 2, 0);
    PutWindowTilemap(8);
