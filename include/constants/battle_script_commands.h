...
#define VARIOUS_RESET_PLAYER_FAINTED            8
...
#define VARIOUS_DRAW_ARENA_REF_TEXT_BOX         15
#define VARIOUS_ERASE_ARENA_REF_TEXT_BOX        16
...
#define VARIOUS_PALACE_TRY_ESCAPE_STATUS        25
