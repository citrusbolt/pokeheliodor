...
extern const u8 gFontFRLGELatinGlyphWidths[];
extern const u16 gFontELatinGlyphs[];
extern const u8 gFontELatinGlyphWidths[];
extern const u16 gFontRSLatinGlyphs[];
extern const u8 gFontRSLatinGlyphWidths[];
