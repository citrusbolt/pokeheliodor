...
u8 *GetMapNameHoennKanto(u8 *dest, u16 mapSecId);
u8 *GetMapNameOrre(u8 *dest, u16 mapSecId, bool8 isXD);
u8 *GetMapNameJohto(u8 *dest, u16 mapSecId);
u8 *GetMapNameSinnoh(u8 *dest, u16 mapSecId);
