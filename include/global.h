...
struct SaveBlock1
{
    ...
    /*0x560*/ u16 bagPocket_TM[50];
              u16 bagPocket_Berries[BAG_BERRIES_COUNT];
              u16 bagPocket_Mail[BAG_MAIL_COUNT];
              u16 extraItemSpace1;
    ...
    /*0x3B24*/ u8 freeDexSpace2[4];
               struct SavedPokemonStats savedPokemonStats[PARTY_SIZE];
