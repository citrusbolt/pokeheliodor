...
extern const u8 gMenuText_MoveToFreeSpace[];
extern const u8 gMenuText_ReturnToPocket[];
...
extern const u8 gText_SaveFileConvertRS[];
extern const u8 gText_SaveFileConvertNo[];
extern const u8 gText_SaveFileConvertE[];
...
extern const u8 gText_FireStone3BP[];
extern const u8 gText_WaterStone3BP[];
extern const u8 gText_ThunderStone3BP[];
extern const u8 gText_LeafStone3BP[];
extern const u8 gText_MoonStone3BP[];
extern const u8 gText_SunStone3BP[];
extern const u8 gText_DragonScale3BP[];
extern const u8 gText_MetalCoat3BP[];
extern const u8 gText_UpGrade3BP[];
extern const u8 gText_DeepSeaScale3BP[];
extern const u8 gText_DeepSeaTooth3BP[];
...
extern const u8 gText_Stick48BP[];
extern const u8 gText_ThickClub48BP[];
extern const u8 gText_LuckyPunch48BP[];
extern const u8 gText_LaxIncense48BP[];
extern const u8 gText_SeaIncense48BP[];
...
extern const u8 gText_FuryCutter32BP[];
extern const u8 gText_Metronome48BP[];
extern const u8 gText_Mimic48BP[];
extern const u8 gText_Rollout32BP[];
extern const u8 gText_SleepTalk48BP[];
extern const u8 gText_Substitute48BP[];
extern const u8 gText_Swagger48BP[];
extern const u8 gText_Nightmare48BP[];
extern const u8 gText_SelfDestruct48BP[];
extern const u8 gText_SkyAttack48BP[];
extern const u8 gText_BlastBurn64BP[];
extern const u8 gText_FrenzyPlant64BP[];
extern const u8 gText_HydroCannon64BP[];
extern const u8 gText_FaintAttack48BP[];
extern const u8 gText_FakeOut48BP[];
extern const u8 gText_Hypnosis48BP[];
extern const u8 gText_NightShade48BP[];
extern const u8 gText_RolePlay48BP[];
extern const u8 gText_ZapCannon48BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FireStoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WaterStoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ThunderStoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LeafStoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MoonStoneDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SunStoneDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_StickDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ThickClubDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LuckyPunchDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LaxIncenseDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SeaIncenseDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_SelfDestructDesc[];
...
extern const u8 BattleFrontier_Lounge7_Text_FaintAttackDesc[];
extern const u8 BattleFrontier_Lounge7_Text_FakeOutDesc[];
extern const u8 BattleFrontier_Lounge7_Text_HypnosisDesc[];
extern const u8 BattleFrontier_Lounge7_Text_NightShadeDesc[];
extern const u8 BattleFrontier_Lounge7_Text_RolePlayDesc[];
extern const u8 BattleFrontier_Lounge7_Text_ZapCannonDesc[];
...
extern const u8 gText_CouponExchange[];
extern const u8 gText_Incubator[];
extern const u8 gText_2324[];
extern const u8 gText_2223[];
extern const u8 gText_2122[];
extern const u8 gText_2021[];
extern const u8 gText_1920[];
extern const u8 gText_1819[];
extern const u8 gText_1718[];
extern const u8 gText_1617[];
extern const u8 gText_1516[];
extern const u8 gText_1415[];
extern const u8 gText_1314[];
extern const u8 gText_1213[];
extern const u8 gText_1112[];
extern const u8 gText_1011[];
extern const u8 gText_910[];
extern const u8 gText_89[];
extern const u8 gText_78[];
extern const u8 gText_67[];
extern const u8 gText_56[];
extern const u8 gText_45[];
extern const u8 gText_34[];
extern const u8 gText_23[];
extern const u8 gText_12[];
extern const u8 gText_Hours[];
extern const u8 gText_Minutes[];
extern const u8 gText_Minute[];
extern const u8 gText_PremierBall1000pt[];
extern const u8 gText_LuxuryBall1500pt[];
extern const u8 gText_RareCandy10000pt[];
extern const u8 gText_LiechiBerry15000pt[];
extern const u8 gText_GanlonBerry15000pt[];
extern const u8 gText_SalacBerry15000pt[];
extern const u8 gText_PetayaBerry15000pt[];
extern const u8 gText_ApicotBerry15000pt[];
extern const u8 gText_LansatBerry15000pt[];
extern const u8 gText_StarfBerry15000pt[];
extern const u8 gText_RegirockDoll60000pt[];
extern const u8 gText_RegiceDoll60000pt[];
extern const u8 gText_RegisteelDoll60000pt[];
extern const u8 gText_MasterBall100000pt[];
extern const u8 gText_50BP10000pt[];
extern const u8 gText_500BP100000pt[];
extern const u8 EventScript_CouponExchange_Text_PremierBallDesc[];
extern const u8 EventScript_CouponExchange_Text_LuxuryBallDesc[];
extern const u8 EventScript_CouponExchange_Text_RareCandyDesc[];
extern const u8 EventScript_CouponExchange_Text_LiechiBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_GanlonBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_SalacBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_PetayaBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_ApicotBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_LansatBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_StarfBerryDesc[];
extern const u8 EventScript_CouponExchange_Text_RegirockDollDesc[];
extern const u8 EventScript_CouponExchange_Text_RegiceDollDesc[];
extern const u8 EventScript_CouponExchange_Text_RegisteelDollDesc[];
extern const u8 EventScript_CouponExchange_Text_MasterBallDesc[];
extern const u8 EventScript_CouponExchange_Text_50BPDesc[];
extern const u8 EventScript_CouponExchange_Text_500BPDesc[];
...
extern const u8 gText_PowerItem[];
extern const u8 gText_PowerTraining[];
...
extern const u8 gText_PowerPurchaseHatch1[];
extern const u8 gText_PowerPurchaseHatch2[];
extern const u8 gText_PowerPurchaseHatch3[];
extern const u8 gText_PowerPurchaseBargain1[];
extern const u8 gText_PowerPurchaseBargain2[];
extern const u8 gText_PowerPurchaseBargain3[];
extern const u8 gText_PowerPurchasePrize1[];
extern const u8 gText_PowerPurchasePrize2[];
extern const u8 gText_PowerPurchasePrize3[];
extern const u8 gText_PowerPurchaseExp1[];
extern const u8 gText_PowerPurchaseExp2[];
extern const u8 gText_PowerPurchaseExp3[];
extern const u8 gText_PowerPurchaseCapture1[];
extern const u8 gText_PowerPurchaseCapture2[];
extern const u8 gText_PowerPurchaseCapture3[];
extern const u8 gText_PowerPurchaseEncounter1[];
extern const u8 gText_PowerPurchaseEncounter2[];
extern const u8 gText_PowerPurchaseEncounter3[];
extern const u8 gText_PowerPurchaseStealth1[];
extern const u8 gText_PowerPurchaseStealth2[];
extern const u8 gText_PowerPurchaseStealth3[];
extern const u8 gText_PowerPurchaseFriend1[];
extern const u8 gText_PowerPurchaseFriend2[];
extern const u8 gText_PowerPurchaseFriend3[];
extern const u8 gText_PowerPurchaseItem1[];
extern const u8 gText_PowerPurchaseItem2[];
extern const u8 gText_PowerPurchaseItem3[];
extern const u8 gText_PowerPurchaseTraining1[];
extern const u8 gText_PowerPurchaseTraining2[];
extern const u8 gText_PowerPurchaseTraining3[];
extern const u8 gText_PowerPurchaseLucky1[];
extern const u8 gText_PowerPurchaseLucky2[];
extern const u8 gText_PowerPurchaseLucky3[];
extern const u8 EventScript_PowerPurchase_Text_HatchDesc1[];
extern const u8 EventScript_PowerPurchase_Text_HatchDesc2[];
extern const u8 EventScript_PowerPurchase_Text_HatchDesc3[];
extern const u8 EventScript_PowerPurchase_Text_BargainDesc1[];
extern const u8 EventScript_PowerPurchase_Text_BargainDesc2[];
extern const u8 EventScript_PowerPurchase_Text_BargainDesc3[];
extern const u8 EventScript_PowerPurchase_Text_PrizeDesc1[];
extern const u8 EventScript_PowerPurchase_Text_PrizeDesc2[];
extern const u8 EventScript_PowerPurchase_Text_PrizeDesc3[];
extern const u8 EventScript_PowerPurchase_Text_ExpDesc1[];
extern const u8 EventScript_PowerPurchase_Text_ExpDesc2[];
extern const u8 EventScript_PowerPurchase_Text_ExpDesc3[];
extern const u8 EventScript_PowerPurchase_Text_CaptureDesc1[];
extern const u8 EventScript_PowerPurchase_Text_CaptureDesc2[];
extern const u8 EventScript_PowerPurchase_Text_CaptureDesc3[];
extern const u8 EventScript_PowerPurchase_Text_EncounterDesc1[];
extern const u8 EventScript_PowerPurchase_Text_EncounterDesc2[];
extern const u8 EventScript_PowerPurchase_Text_EncounterDesc3[];
extern const u8 EventScript_PowerPurchase_Text_StealthDesc1[];
extern const u8 EventScript_PowerPurchase_Text_StealthDesc2[];
extern const u8 EventScript_PowerPurchase_Text_StealthDesc3[];
extern const u8 EventScript_PowerPurchase_Text_FriendDesc1[];
extern const u8 EventScript_PowerPurchase_Text_FriendDesc2[];
extern const u8 EventScript_PowerPurchase_Text_FriendDesc3[];
extern const u8 EventScript_PowerPurchase_Text_ItemDesc1[];
extern const u8 EventScript_PowerPurchase_Text_ItemDesc2[];
extern const u8 EventScript_PowerPurchase_Text_ItemDesc3[];
extern const u8 EventScript_PowerPurchase_Text_TrainingDesc1[];
extern const u8 EventScript_PowerPurchase_Text_TrainingDesc2[];
extern const u8 EventScript_PowerPurchase_Text_TrainingDesc3[];
...
extern const u8 gText_HCardPokeCoupons[];
extern const u8 gText_HCardNumPokeCoupons[];
extern const u8 gText_HCardWinsLosses[];
extern const u8 gText_HCardTrainerName[];
extern const u8 gText_HCardLinkTrades[];
extern const u8 gText_HCardFrontPowerPoints[];
extern const u8 gText_HCardFrontBattlePoints[];
extern const u8 gText_HCardFrontPokeCoupons[];
extern const u8 gText_HCardFrontBattlePointsQuantity[];
extern const u8 gText_HCardFrontPokeCouponsQuantity[];
extern const u8 gText_BlackCard[];
extern const u8 gText_CardTerminal_Type[];
...
extern const u8 gText_CardTerminal_TypeH[];
extern const u8 gText_CardTerminal_StickerHOF[];
extern const u8 gText_CardTerminal_StickerEgg[];
extern const u8 gText_CardTerminal_StickerBattle[];
extern const u8 gText_CardTerminal_StickerShiny[];
extern const u8 gText_CardTerminal_StickerBerry[];
extern const u8 gText_CardTerminal_StickerCatch[];
extern const u8 gText_CardTerminal_TintNormal[];
extern const u8 gText_CardTerminal_TintBlack[];
extern const u8 gText_CardTerminal_TintPink[];
extern const u8 gText_CardTerminal_TintSepia[];
extern const u8 gText_CardTerminal_StatBlank[];
extern const u8 gText_CardTerminal_StatHOF[];
extern const u8 gText_CardTerminal_StatBattle[];
extern const u8 gText_CardTerminal_StatTrade[];
extern const u8 gText_CardTerminal_StatPokeblock[];
extern const u8 gText_CardTerminal_StatContest[];
extern const u8 gText_CardTerminal_StatTower[];
extern const u8 gText_CardTerminal_StatUnionRoom[];
extern const u8 gText_CardTerminal_StatBerryCrush[];
extern const u8 gText_CardTerminal_StatBattlePoints[];
extern const u8 gText_CardTerminal_StatShiny[];
extern const u8 gText_CardTerminal_StatPowerPoints[];
extern const u8 gText_CardTerminal_StatPokeCoupons[];
extern const u8 gText_CardTerminal_StickerHOFName[];
extern const u8 gText_CardTerminal_StickerEggName[];
extern const u8 gText_CardTerminal_StickerBattleName[];
extern const u8 gText_CardTerminal_StickerShinyName[];
